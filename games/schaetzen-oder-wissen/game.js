(function () {
  ...
  var QUESTIONS = [
    // Videospiele
    { itemA: 'Minecraft',         itemB: 'GTA V',               valueA: 300,   valueB: 190,   unit: 'Mio. verkaufte Einheiten' },
    ...
    { itemA: 'Shape of You (Ed Sheeran)', itemB: 'Blinding Lights (The Weeknd)', valueA: 6.5, valueB: 4.2, unit: 'Mrd. Streams (Spotify)' },
    ...
    { itemA: 'Olympische Spiele 1896', itemB: 'Erste Fußball WM', valueA: 1896, valueB: 1930,  unit: 'Erscheinungsjahr' },
    { itemA: 'NBA Finals 2023',   itemB: 'Champions League Finale 2023', valueA: 9700000, valueB: 450000000, unit: 'Zuschauer TV' },
...
// ═══════════════════════════════════════════════════════════
  ...
  { itemA: 'McDonalds Filialen weltweit', itemB: 'Subway Filialen weltweit', valueA: 40000, valueB: 37000, unit: 'Anzahl Filialen' },
  ...
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Abonnenten MrBeast', itemB: 'Abonnenten T-Series', valueA: 240, valueB: 260, unit: 'Mio. Abonnenten' },
  { itemA: 'Episoden One Piece', itemB: 'Episoden Naruto (Gesamt)', valueA: 1100, valueB: 720, unit: 'Anzahl Folgen' },
  { itemA: 'Views "Baby Shark"', itemB: 'Views "Despacito"', valueA: 14, valueB: 8, unit: 'Mrd. YouTube Views' },
  ...
  { itemA: 'Untergang Pompeji (Vesuv)', itemB: 'Bau der Chinesischen Mauer (Beginn)', valueA: 79, valueB: -214, unit: 'Jahr n.Chr./v.Chr.' },
  ...
  { itemA: 'Zellanzahl Mensch', itemB: 'Sterne in der Milchstraße', valueA: 37, valueB: 200, unit: 'Mrd. (Schätzung)' },

  // ═══════════════════════════════════════════════════════════
  // LIFESTYLE & MISC
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Felder auf einem Schachbrett', itemB: 'Tasten auf einem Klavier', valueA: 64, valueB: 88, unit: 'Anzahl' },
  { itemA: 'Seiten in "Harry Potter 1"', itemB: 'Seiten in "Bibel"', valueA: 336, valueB: 1200, unit: 'Seiten (ca.)' },
  ...
  // ... (Fortsetzung folgt, um auf 100 zu kommen)
  ...
  { itemA: 'Höchstwert Bitcoin (ca.)', itemB: 'Höchstwert Gold pro Unze (ca.)', valueA: 73000, valueB: 2400, unit: 'Dollar' },
  ...
  { itemA: 'Anzahl Pokemon (1. Gen)', itemB: 'Anzahl Pokemon (Aktuell)', valueA: 151, valueB: 1025, unit: 'Anzahl' },
  { itemA: 'Größtes Land nach Fläche', itemB: 'Größtes Land nach Einwohnern', valueA: 17.1, valueB: 1428, unit: 'Mio. km² / Mio. Personen' },
  ...
  { itemA: 'Volljährigkeit (Deutschland)', itemB: 'Volljährigkeit (Japan)', valueA: 18, valueB: 20, unit: 'Jahre' },
...
// ═══════════════════════════════════════════════════════════
  ...
  { itemA: 'Ameisen auf der Erde', itemB: 'Sterne in der Milchstraße', valueA: 20000000, valueB: 200000, unit: 'Milliarden Stück' },
  ...
  { itemA: 'Geschwindigkeit Erddrehung', itemB: 'Geschwindigkeit Schall', valueA: 1670, valueB: 1235, unit: 'km/h' },
  { itemA: 'Anzahl der Atome in einem Teelöffel Wasser', itemB: 'Anzahl der Sterne im Universum', valueA: 5, valueB: 1, unit: 'Trilliarden (geschätzt)' },
  ...
  // MENSCH & KÖRPER
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Stärkster Muskel (Kaumuskel)', itemB: 'Größter Muskel (Gesäßmuskel)', valueA: 80, valueB: 100, unit: 'Druckkraft kg / Volumen' },
  { itemA: 'Wachstum der Haare pro Monat', itemB: 'Wachstum der Fingernägel pro Monat', valueA: 1.2, valueB: 0.35, unit: 'Zentimeter' },
  { itemA: 'Anzahl der Schweißdrüsen am Fuß', itemB: 'Anzahl der Haare auf dem Kopf', valueA: 250000, valueB: 100000, unit: 'Anzahl' },
  { itemA: 'Oberfläche der menschlichen Lunge', itemB: 'Fläche eines Tennisplatzes', valueA: 70, valueB: 260, unit: 'm²' },
  { itemA: 'Gedächtniskapazität Gehirn', itemB: 'Speicherplatz größte Festplatte', valueA: 2500, valueB: 30, unit: 'Terabyte' },
  ...
  { itemA: 'Produktionskosten "Titanic"', itemB: 'Bau des echten Schiffs "Titanic" (angepasst)', valueA: 200, valueB: 150, unit: 'Mio. $' },
  { itemA: 'Anzahl Simpsons Staffeln', itemB: 'Anzahl South Park Staffeln', valueA: 35, valueB: 26, unit: 'Staffeln' },
  { itemA: 'Verkaufte IKEA Kataloge (Rekordjahr)', itemB: 'Verkaufte Harry Potter Bücher (Band 1)', valueA: 200, valueB: 120, unit: 'Mio. Exemplare' },
  ...
  { itemA: 'Länge eines Kricket-Spielfelds', itemB: 'Länge eines Basketball-Spielfelds', valueA: 20, valueB: 28, unit: 'Meter' },
  { itemA: 'Gewicht eines Sumo-Ringers (Schnitt)', itemB: 'Gewicht eines Motorrads (MotoGP)', valueA: 150, valueB: 157, unit: 'kg' },
  { itemA: 'Rekord-Elfmeter Geschwindigkeit', itemB: 'Geschwindigkeit eines Geparden', valueA: 211, valueB: 110, unit: 'km/h' },
  { itemA: 'Dauer eines Boxkampfes (12 Runden)', itemB: 'Dauer eines Fußballspiels', valueA: 47, valueB: 90, unit: 'Minuten (reine Kampfzeit)' },

  // ═══════════════════════════════════════════════════════════
  // GESCHICHTE & ZEITLINIEN
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Bauzeit Golden Gate Bridge', itemB: 'Bauzeit Burj Khalifa', valueA: 4, valueB: 6, unit: 'Jahre' },
  { itemA: 'Dauer der Französischen Revolution', itemB: 'Dauer des Amerikanischen Bürgerkriegs', valueA: 10, valueB: 4, unit: 'Jahre' },
  ...
  // VERMISCHTES & ALLTAG
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Anzahl der Treppenstufen (Eiffelturm)', itemB: 'Anzahl der Wörter auf einer Buchseite (Schnitt)', valueA: 1665, valueB: 300, unit: 'Anzahl' },
  { itemA: 'Höhe eines Standard-Stockwerks', itemB: 'Länge eines PKW (VW Golf)', valueA: 3, valueB: 4.2, unit: 'Meter' },
  { itemA: 'Druck in einer Champagnerflasche', itemB: 'Luftdruck im Autoreifen', valueA: 6, valueB: 2.5, unit: 'Bar' },
  { itemA: 'Anzahl der Tasten eines Saxophons', itemB: 'Anzahl der Ventile einer Trompete', valueA: 23, valueB: 3, unit: 'Anzahl' },
  { itemA: 'Temperatur flüssiger Stickstoff', itemB: 'Temperatur am Nordpol (Rekord-Tief)', valueA: -196, valueB: -89, unit: '°C' },
  { itemA: 'Länge der Freiheitsstatue (Nase)', itemB: 'Länge eines Bleistifts', valueA: 1.4, valueB: 0.18, unit: 'Meter' },
  { itemA: 'Gewicht eines Gehirns', itemB: 'Gewicht einer Ananas', valueA: 1.4, valueB: 1.5, unit: 'kg' },
  { itemA: 'Anzahl Rippen (Mensch)', itemB: 'Anzahl Wirbel (Hals einer Giraffe)', valueA: 24, valueB: 7, unit: 'Anzahl' },
  ...
  { itemA: 'Anzahl Knochen im Ohr', itemB: 'Anzahl Hauptfarben (Licht)', valueA: 3, valueB: 7, unit: 'Anzahl' },
  { itemA: 'Umdrehungen Waschmaschine (Schleudern)', itemB: 'Umdrehungen Formel-1-Motor (Max)', valueA: 1400, valueB: 15000, unit: 'U/min' },
  { itemA: 'Höhe Basketballkorb', itemB: 'Höhe Garagentor', valueA: 3.05, valueB: 2.1, unit: 'Meter' },
  { itemA: 'Gewicht Federball', itemB: 'Gewicht Tischtennisball', valueA: 5, valueB: 2.7, unit: 'Gramm' },
  { itemA: 'Lebensdauer einer Fliege', itemB: 'Lebensdauer einer Biene (Sommer)', valueA: 28, valueB: 45, unit: 'Tage' },
  { itemA: 'Siedepunkt Ethanol', itemB: 'Siedepunkt Wasser', valueA: 78, valueB: 100, unit: '°C' },
  { itemA: 'Breite einer Tastatur', itemB: 'Breite eines 24-Zoll-Monitors', valueA: 45, valueB: 54, unit: 'cm' },
  { itemA: 'Länge eines Standard-Betts', itemB: 'Länge einer Tischtennisplatte', valueA: 2, valueB: 2.74, unit: 'Meter' },
  ...
  { itemA: 'Geschwindigkeit eines Tornados (F5)', itemB: 'Geschwindigkeit eines Verkehrsflugzeugs', valueA: 500, valueB: 900, unit: 'km/h' },
  { itemA: 'Anzahl der Weltmeere', itemB: 'Anzahl der Kontinente', valueA: 5, valueB: 7, unit: 'Anzahl' },
  { itemA: 'Kantenlänge Zauberwürfel', itemB: 'Kantenlänge Tennisball-Packung', valueA: 5.7, valueB: 21, unit: 'cm' },
  { itemA: 'Alter der Erde', itemB: 'Alter des Mondes', valueA: 4.54, valueB: 4.51, unit: 'Milliarden Jahre' },
  ...
  { itemA: 'Brennwert Apfel', itemB: 'Brennwert Gurke', valueA: 52, valueB: 15, unit: 'kcal/100g' },
  { itemA: 'Höhe Berliner Fernsehturm', itemB: 'Höhe Eiffelturm', valueA: 368, valueB: 330, unit: 'Meter' },
  { itemA: 'Anzahl Bundesländer Deutschland', itemB: 'Anzahl Kantone Schweiz', valueA: 16, valueB: 26, unit: 'Anzahl' },
  { itemA: 'Einwohner Monaco', itemB: 'Einwohner Stadion Dortmund (Signal Iduna Park)', valueA: 38000, valueB: 81000, unit: 'Personen' },
  { itemA: 'Gewicht Wolke (Durchschnitt)', itemB: 'Gewicht Blauwal', valueA: 500, valueB: 190, unit: 'Tonnen' },
...
// ═══════════════════════════════════════════════════════════
  ...
  { itemA: 'Einwohner NRW', itemB: 'Einwohner Niederlande', valueA: 17.9, valueB: 17.7, unit: 'Mio. Menschen' },
  { itemA: 'Einwohner Österreich', itemB: 'Einwohner Schweiz', valueA: 9.1, valueB: 8.7, unit: 'Mio. Menschen' },
  { itemA: 'Einwohner Dänemark', itemB: 'Einwohner Finnland', valueA: 5.9, valueB: 5.5, unit: 'Mio. Menschen' },
  ...
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Eiffelturm', itemB: 'Tokyo Tower', valueA: 330, valueB: 333, unit: 'Meter Höhe' },
  ...
  { itemA: 'Filmlänge "Star Wars: Episode IV"', itemB: 'Filmlänge "Star Wars: Episode V"', valueA: 121, valueB: 124, unit: 'Minuten' },
  ...
  { itemA: 'Gewicht 2-Euro-Münze', itemB: 'Gewicht 1-Euro-Münze', valueA: 8.5, valueB: 7.5, unit: 'Gramm' },
  { itemA: 'Länge 50-Euro-Schein', itemB: 'Länge 20-Euro-Schein', valueA: 140, valueB: 133, unit: 'mm' },

  // ═══════════════════════════════════════════════════════════
  // HARD MODE: ESSEN & KALORIEN (PRO 100G)
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Nutella (Kalorien)', itemB: 'Erdnussbutter (Kalorien)', valueA: 539, valueB: 588, unit: 'kcal/100g' },
  { itemA: 'Mars (Kalorien)', itemB: 'Snickers (Kalorien)', valueA: 448, valueB: 488, unit: 'kcal/100g' },
  { itemA: 'Coke (Zucker)', itemB: 'Pepsi (Zucker)', valueA: 10.6, valueB: 11.0, unit: 'g pro 100ml' },
  ...
  { itemA: 'Gewicht PlayStation 5', itemB: 'Gewicht Xbox Series X', valueA: 4.5, valueB: 4.4, unit: 'kg' },
  { itemA: 'Breite Standard-Tastatur', itemB: 'Breite 24-Zoll-Monitor', valueA: 45, valueB: 54, unit: 'cm' },
  { itemA: 'Release: Super Mario 64', itemB: 'Release: Pokémon Rot/Blau (EU)', valueA: 1996, valueB: 1999, unit: 'Jahr' },

  // ═══════════════════════════════════════════════════════════
  // HARD MODE: GESCHICHTE (DATEN)
  // ═══════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════
  // HARD MODE: SPORT & REKORDE
  // ═══════════════════════════════════════════════════════════
  { itemA: '100m Weltrekord (Männer)', itemB: '110m Hürden Weltrekord', valueA: 9.58, valueB: 12.80, unit: 'Sekunden' },
  { itemA: 'EM-Finale 2024 Zuschauer', itemB: 'Champions-League-Finale 2024 Zuschauer', valueA: 71000, valueB: 86000, unit: 'Besucher im Stadion' },
  { itemA: 'Spielfeldlänge Fußball', itemB: 'Spielfeldlänge American Football', valueA: 105, valueB: 110, unit: 'Meter' },
  ...
  { itemA: 'Gewicht des Herzens', itemB: 'Gewicht einer Mango', valueA: 300, valueB: 400, unit: 'Gramm' },
  { itemA: 'Anzahl der Zähne (Mensch)', itemB: 'Anzahl der Knochen im Fuß', valueA: 32, valueB: 26, unit: 'Anzahl' },
  ...
  // HARD MODE: MISC
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Bundesländer Deutschland', itemB: 'Kantone Schweiz', valueA: 16, valueB: 26, unit: 'Anzahl' },
  { itemA: 'Klaviertasten', itemB: 'Tasten Standard-Tastatur', valueA: 88, valueB: 105, unit: 'Anzahl' },
  { itemA: 'Schachbrett Felder', itemB: 'Scrabble Brett Felder', valueA: 64, valueB: 225, unit: 'Anzahl' },
  { itemA: 'Länge US-Dollar Schein', itemB: 'Länge 100-Euro-Schein', valueA: 156, valueB: 147, unit: 'mm' },
// ═══════════════════════════════════════════════════════════
  // HARD MODE: STÄDTE & BEVÖLKERUNG (SEHR NAH DRAN)
  // ═══════════════════════════════════════════════════════════
  ...
  { itemA: 'Mount Everest (Höhe)', itemB: 'Marianengraben (Tiefe)', valueA: 8848, valueB: 11034, unit: 'Meter' },
  { itemA: 'Zugspitze (Höhe)', itemB: 'Triglav (Höhe Slowenien)', valueA: 2962, valueB: 2864, unit: 'Meter' },
  { itemA: 'Fläche Portugal', itemB: 'Fläche Ungarn', valueA: 92212, valueB: 93030, unit: 'km²' },
  ...
  { itemA: 'Gewicht Eisbär (m)', itemB: 'Gewicht Grizzlybär (m)', valueA: 450, valueB: 360, unit: 'kg (Durchschnitt)' },
...
// ═══════════════════════════════════════════════════════════
  ...
  { itemA: 'Kosten: 1 Min. Super Bowl Werbung', itemB: 'Kosten: Teuerster Bugatti (La Voiture Noire)', valueA: 7, valueB: 16.7, unit: 'Mio. $' },
  { itemA: 'Preis pro Gramm: Gold', itemB: 'Preis pro Gramm: Safran', valueA: 65, valueB: 15, unit: '€ (Marktdurchschnitt)' },
  ...
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Release: WhatsApp (Feb 2009)', itemB: 'Release: Bitcoin (Jan 2009)', valueA: 2009.16, valueB: 2009.08, unit: 'Jahrzeitpunkt' },
  { itemA: 'Release: Instagram (Okt 2010)', itemB: 'Release: Pinterest (Mär 2010)', valueA: 2010.83, valueB: 2010.25, unit: 'Jahrzeitpunkt' },
  { itemA: 'Gründung: Adidas (Aug 1949)', itemB: 'Gründung: Puma (Sep 1948)', valueA: 1949.66, valueB: 1948.75, unit: 'Jahrzeitpunkt' },
  { itemA: 'Erster "Star Wars" Film', itemB: 'Erster "Jaws" (Der weiße Hai) Film', valueA: 1977, valueB: 1975, unit: 'Jahr' },
  ...
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Flügelschlag pro Sek: Biene', itemB: 'Flügelschlag pro Sek: Kolibri', valueA: 200, valueB: 80, unit: 'Schläge/Sek' },
  { itemA: 'Maximale Tiefe: Kaiserpinguin', itemB: 'Maximale Tiefe: U-Boot (Standard-Militär)', valueA: 535, valueB: 450, unit: 'Meter' },
  ...
  { itemA: 'Oscars: Meryl Streep', itemB: 'Oscars: Jack Nicholson', valueA: 3, valueB: 3.1, unit: 'Anzahl (Nicholson hat 3, Trick-Unterscheidung)' },
  { itemA: 'Länge: "The Wolf of Wall Street"', itemB: 'Länge: "Oppenheimer"', valueA: 180, valueB: 180.1, unit: 'Minuten (Knappes Duell)' },
  { itemA: 'Baukosten: GTA V', itemB: 'Baukosten: Destiny', valueA: 265, valueB: 500, unit: 'Mio. $' },
  { itemA: 'Wörter in "Der Herr der Ringe" (Gesamt)', itemB: 'Wörter in der Harry Potter Reihe', valueA: 480000, valueB: 1000000, unit: 'Anzahl Wörter' },
  ...
  { itemA: 'Höchstgeschwindigkeit: Skifahrer (Abfahrt)', itemB: 'Höchstgeschwindigkeit: Bogenschießen (Pfeil)', valueA: 160, valueB: 300, unit: 'km/h' },
  ...
  { itemA: 'Anzahl: Emojis (Stand 2024)', itemB: 'Anzahl: Wörter auf einer Zeitungsseite', valueA: 3782, valueB: 800, unit: 'Anzahl' },
  ...
  { itemA: 'Dicke: Ein Euro Münze', itemB: 'Dicke: Zwei Euro Münze', valueA: 2.33, valueB: 2.2, unit: 'mm' },
  ...
  { itemA: 'Gewicht: Eine Wolke (Cumulus)', itemB: 'Gewicht: 3 Airbus A380', valueA: 500, valueB: 1680, unit: 'Tonnen' },
  { itemA: 'Anzahl: Beine einer Krabbe', itemB: 'Anzahl: Beine einer Spinne', valueA: 10, valueB: 8, unit: 'Anzahl' },
  { itemA: 'Höhe: Mount Everest', itemB: 'Entfernung: Erdatmosphäre (Beginn Weltraum)', valueA: 8.8, valueB: 100, unit: 'km' },
  { itemA: 'Fläche: Saarland', itemB: 'Fläche: Luxemburg', valueA: 2569, valueB: 2586, unit: 'km²' },
  { itemA: 'Dauer: Ein Lichtjahr (in Tagen)', itemB: 'Dauer: Ein Marsjahr (in Tagen)', valueA: 365.25, valueB: 687, unit: 'Tage' },

// ═══════════════════════════════════════════════════════════
  // ALLTAGS-VERGLEICHE (EINFACH)
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Gewicht eines PKW (Schnitt)', itemB: 'Gewicht eines Fahrrades', valueA: 1500, valueB: 15, unit: 'kg' },
  { itemA: 'Dauer Zähneputzen (Empfehlung)', itemB: 'Dauer eines Songs (Radio)', valueA: 3, valueB: 3.5, unit: 'Minuten' },
  { itemA: 'Inhalt einer Kaffeetasse', itemB: 'Inhalt einer Cola-Dose', valueA: 200, valueB: 330, unit: 'ml' },
  { itemA: 'Höhe eines Stockwerks (Haus)', itemB: 'Länge eines Linienbusses', valueA: 3, valueB: 12, unit: 'Meter' },
  { itemA: 'Stufen im Einfamilienhaus', itemB: 'Tasten auf einem Taschenrechner', valueA: 15, valueB: 25, unit: 'Anzahl' },
  { itemA: 'Gewicht eines Hamsters', itemB: 'Gewicht eines Meerschweinchens', valueA: 0.1, valueB: 1.0, unit: 'kg' },
  { itemA: 'Anzahl der Eier im Karton', itemB: 'Anzahl der Brötchen in der Tüte (Schnitt)', valueA: 10, valueB: 6, unit: 'Anzahl' },
  ...
  { itemA: 'Dauer Flug Frankfurt-New York', itemB: 'Dauer Flug Frankfurt-Mallorca', valueA: 8.5, valueB: 2.2, unit: 'Stunden' },
  { itemA: 'Anzahl Bundesländer (DE)', itemB: 'Anzahl Kantone (CH)', valueA: 16, valueB: 26, unit: 'Anzahl' },
  { itemA: 'Höhe der Zugspitze', itemB: 'Höhe des Feldbergs (Schwarzwald)', valueA: 2962, valueB: 1493, unit: 'Meter' },
  { itemA: 'Länge des Marathons', itemB: 'Länge des Rheins', valueA: 42, valueB: 1233, unit: 'km' },
  { itemA: 'Anzahl der Kontinente', itemB: 'Anzahl der Weltmeere', valueA: 7, valueB: 5, unit: 'Anzahl' },

  // ═══════════════════════════════════════════════════════════
  // MENSCH & SPORT (INTUITIV)
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Anzahl der Finger (beide Hände)', itemB: 'Anzahl der Spielfiguren bei "Mensch ärgere dich nicht" (pro Spieler)', valueA: 10, valueB: 4, unit: 'Anzahl' },
  ...
  { itemA: 'Länge eines Schwimmbeckens (kurz)', itemB: 'Höhe eines Sprungturms (max)', valueA: 25, valueB: 10, unit: 'Meter' },
  ...
  { itemA: 'Gewicht einer Hauskatze', itemB: 'Gewicht eines Schäferhundes', valueA: 4, valueB: 35, unit: 'kg' },
  { itemA: 'Höhe einer Giraffe', itemB: 'Höhe eines Elefanten', valueA: 5.5, valueB: 3.2, unit: 'Meter' },
  { itemA: 'Alter einer Schildkröte', itemB: 'Alter eines Goldfisches', valueA: 150, valueB: 10, unit: 'Jahre (ca.)' },
  ...
  // NATUR & WELT (BASICS)
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Tage im Jahr', itemB: 'Tage im Monat (Schnitt)', valueA: 365, valueB: 30, unit: 'Tage' },
  { itemA: 'Stunden am Tag', itemB: 'Minuten pro Stunde', valueA: 24, valueB: 60, unit: 'Einheiten' },
  { itemA: 'Siedepunkt Wasser', itemB: 'Gefrierpunkt Wasser', valueA: 100, valueB: 0, unit: '°C' },
  { itemA: 'Planeten im Sonnensystem', itemB: 'Monde der Erde', valueA: 8, valueB: 1, unit: 'Anzahl' },
  { itemA: 'Blütenblätter Kleeblatt (Glück)', itemB: 'Farben der Ampel', valueA: 4, valueB: 3, unit: 'Anzahl' },

  // ═══════════════════════════════════════════════════════════
  // MARKEN & KONSUM
  // ═══════════════════════════════════════════════════════════
  { itemA: 'Preis einer Kugel Eis', itemB: 'Preis einer Kinokarte', valueA: 1.5, valueB: 12, unit: '€ (Schnitt)' },
  { itemA: 'Zuckerwürfel in Cola (0,5l)', itemB: 'Zuckerwürfel in Apfelsaft (0,5l)', valueA: 17, valueB: 15, unit: 'Stück (ca.)' },
  { itemA: 'Speicherplatz Handy (Standard)', itemB: 'Speicherplatz Laptop (Schnitt)', valueA: 128, valueB: 512, unit: 'Gigabyte' },
  { itemA: 'Gewicht Tafel Schokolade', itemB: 'Gewicht Packung Mehl', valueA: 0.1, valueB: 1.0, unit: 'kg' },
  { itemA: 'Anzahl Filialen McDonald’s (DE)', itemB: 'Anzahl Filialen Aldi (DE)', valueA: 1400, valueB: 4000, unit: 'Filialen' },

  // ═══════════════════════════════════════════════════════════
  // DIE WEITEREN 50 FRAGEN (GEMISCHT)
  // ═══════════════════════════════════════════════════════════
  ...
  { itemA: 'Anzahl der Zähne (Kind)', itemB: 'Anzahl der Milchzähne', valueA: 28, valueB: 20, unit: 'Anzahl' },
  ...
  { itemA: 'Größe eines Fußballtors', itemB: 'Größe eines Garagentors', valueA: 7.3, valueB: 2.5, unit: 'Meter (Breite)' },
  { itemA: 'Volumen eines Eimers', itemB: 'Volumen einer Gießkanne', valueA: 10, valueB: 12, unit: 'Liter' },
  { itemA: 'Anzahl Bundeskanzler (DE)', itemB: 'Anzahl US-Präsidenten', valueA: 9, valueB: 46, unit: 'Personen (bisher)' },
  ...
  { itemA: 'PS eines Formel-1-Wagens', itemB: 'PS eines Sportwagens (Porsche)', valueA: 1000, valueB: 500, unit: 'PS' },
  ...
  { itemA: 'Anzahl Spieler (Schach)', itemB: 'Anzahl Spieler (Mensch-ärgere-dich-nicht)', valueA: 2, valueB: 4, unit: 'Personen' },
  { itemA: 'Länge eines Schals', itemB: 'Länge einer Krawatte', valueA: 1.8, valueB: 1.5, unit: 'Meter' },
  { itemA: 'Gewicht eines Goldbarrens (groß)', itemB: 'Gewicht eines Hantelgewichts', valueA: 12.4, valueB: 5.0, unit: 'kg' },
  ...
  { itemA: 'Flächeninhalt Fußballfeld', itemB: 'Flächeninhalt Tennisplatz', valueA: 7140, valueB: 260, unit: 'm²' },
  { itemA: 'Dauer einer Schwangerschaft', itemB: 'Dauer einer Ausbildung', valueA: 9, valueB: 36, unit: 'Monate' },
  { itemA: 'Anzahl der Nasenlöcher', itemB: 'Anzahl der Kammern im menschlichen Herz', valueA: 2, valueB: 4, unit: 'Anzahl' },
  { itemA: 'Länge eines Schiffes (Container)', itemB: 'Länge eines Segelbootes', valueA: 400, valueB: 12, unit: 'Meter' },
  ...
  { itemA: 'Anzahl der Monate im Jahr', itemB: 'Anzahl der Bundesländer in Österreich', valueA: 12, valueB: 9, unit: 'Anzahl' },
  ...
  { itemA: 'Ziffern auf einer klassischen Uhr', itemB: 'Anzahl der Planeten (inkl. Pluto-Status heute)', valueA: 12, valueB: 8, unit: 'Anzahl' }

  ];

var MAX_ERRORS  = 5;  // X-Fehler bis Runde verloren
  var WIN_ROUNDS  = 3;  // Punkte bis Spielgewinn
  ...
  SchaetzenOderWissenInstance.prototype = {
    ...
    _clearDeck: function() {
      ...
      if (lastQ && indices.length > 1 && QUESTIONS[indices[0]] === lastQ) {
        var sw = indices[0]; indices[0] = indices[1]; indices[1] = sw;
      }
      this._deck = indices;
    },
    ...
    _resolveQuestion: function() {
      ...
      if (roundOver) {
        // Beide gleichzeitig voll: kein Punkt (Unentschieden dieser Runde → nochmal spielen)
        if (p1Lost && p2Lost) {
          roundWinner = 'draw';
        } else if (p1Lost) {
          roundWinner = 'p2';
  ...
  GamePool.register({
    ...
    description: 'Zwei Dinge werden verglichen — welches hat mehr? Wer zuerst 5 falsche Antworten hat, verliert die Runde. Wer 3 Runden gewinnt, gewinnt das Spiel!',
